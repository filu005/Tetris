...
Game::Game(int widthInBlocks, int heightInBlocks, GLfloat blockSize) : iterations(0), interval(1.0), _points(0), _doublePoints(0), _lookAheadTetrominos(1), _tetrominoDrawStyle(1), _placedTetrominos(0), _logging(false), _widthInBlocks(widthInBlocks), _heightInBlocks(heightInBlocks)
{
